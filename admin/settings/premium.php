...
<div class="wrap">
	...
	<h2><?php _e( 'WP Responsive header image slider - Features', 'responsive-header-image-slider' ); ?></h2><br />

	<p class="custom-note">Important Recommendations : For better user experience we have shifted  <strong>WP Responsive header image slider</strong> plugin in our to new plugin ie <a href="https://wordpress.org/plugins/sliderspack-all-in-one-image-sliders/" style="color:#fff;" target="_blank"><strong>SlidersPack – All In One Image/Post Slider</strong></a>. It help us to maintain our all slider plugins in a single plugin package and provide you better and fast support.</p>
...
position: relative;background-color: #43AC6A;border-color: #3a945b;color: #FFFFFF;}
		...
		<colgroup></colgroup>	
	    	...
	    	<tr>
	    		...
	    		<th>
	    			<h2>Premium</h2>
	    			<p>Gain access to <strong>SlidersPack</strong> and <strong>all other products</strong> with a single purchase.</p>
	    ...
	    <tfoot>
	    	<tr>
	    		<th></th>
	    		<td></td>
	    		<td><p>Gain access to <strong>SlidersPack</strong> and <strong>all other products</strong> with a single purchase.</p>
				<a href="https://www.wponlinesupport.com/pricing/?ref=wpos_piyush" target="_blank">View Pricing Options</a></td>
	    	</tr>
	    </tfoot>
		<tbody>
			<tr>
				<th>Sliders <span class="subtext">Choose one of 10 different sliders/carousels types from Sliders Pack. <br />Flex Slider 2, bxSlider, Owl Carousel 2, Swiper Slider, 3D Slider, Wallop Slider, unSlider, Nivo Slider, Responsive Slides and Polaroids Gallery</span></th>
				<td>10</td>
				<td>10</td>
			</tr>
			<tr>
